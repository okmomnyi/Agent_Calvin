...
SERVICES: dict[str, list[str]] = {
    ...
    "music": ["test_music.py"],
    "desktop control": ["test_desktop.py", "test_assistant_core.py", "test_audio_io.py"],
    ...
    "research": ["test_research.py", "test_research_request_parsing.py", "test_research_gather.py",
                "test_research_images.py", "test_research_house_style.py",
                "test_research_synthesis.py", "test_research_pdf_builder.py"],
