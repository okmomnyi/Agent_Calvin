...
from skills.job_hunter.sources.himalayas_api import HimalayasInternshipSource
...
def build_sources(fetcher: Fetcher | None = None) -> list[JobSource]:
    ...
    # Internships (#25): a dedicated, always-on, no-key source -- general boards structurally
    # under-surface these, which is why "every scraped role is mid-to-senior" was the complaint.
    sources.append(HimalayasInternshipSource(fetcher))
